...
path = 'G:/xiao/dataset_molcreateV2/data/create_ann/nii/'
...
for mask_path in tqdm(masks_path):
    ...
    try:
        ...
        # plt.show()
        plt.savefig('G:/xiao/dataset_molcreateV2/data/create_ann/check/' + str(time_name) + '_src.pdf_' + str(count_name) + '.png')
        plt.close('all')
    except:
